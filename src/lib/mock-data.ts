...
export let mockIssues: Issue[] = [
    ...
    location: { lat: 40.7145, lng: -74.0080, city: 'New York' },
  ...
  },
  {
    ...
    location: { lat: 40.7295, lng: -73.9965, city: 'New York' },
  ...
  },
  {
    ...
    slaStatus: 'On Time',
    slaDeadline: addHours(now, 48).toISOString(),
    location: { lat: 40.7420, lng: -74.0015, city: 'New York' },
  ...
  },
  {
    ...
    location: { lat: 40.7829, lng: -73.9654, city: 'New York' },
